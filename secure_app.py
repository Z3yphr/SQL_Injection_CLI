...
<!doctype html>
<title>Welcome</title>
<h2>Welcome to the Secure Dummy Site</h2>
<p>This is a secure version of the site for SQL injection and XSS demonstration.</p>
...
def profile():
    ...
    result = ''
    if username:
        # SECURE: Do not use |safe, let Flask escape by default
